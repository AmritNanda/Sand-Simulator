...
def random_color(hue_range, saturation_range, value_range):
    # WE will use HSV values to adjust the natural looking sand particles by adjusting the hue and the saturation then changing it to its RGB equivalent to show that natural gradient of the sand
